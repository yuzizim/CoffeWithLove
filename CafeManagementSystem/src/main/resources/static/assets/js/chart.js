$(function () {
    ...
    // Convert the topProducts data to the format needed for Chart.js
    var productNames = topProducts.map(product => product.name);
    var productQuantities = topProducts.map(product => product.quantity);
